...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-brand-blue/95 to-slate-900 text-white pt-16 pb-6 overflow-relative z-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://www.facebook.com/profile.php?id=61591016540116" className="bg-white/10 p-2 rounded-full hover:bg-brand-orange transition transform hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
              </a>
              
              <a href="https://www.instagram.com/kreativemandu/" className="bg-white/10 p-2 rounded-full hover:bg-brand-orange transition transform hover:scale-110">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 space-y-2 text-sm">
              <div className="flex items-center gap-3">
                ...
                <span>kreativemandu@gmail.com</span>
              </div>
              <div className="flex items-center gap-3">
